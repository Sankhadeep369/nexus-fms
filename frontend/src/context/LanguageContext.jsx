...
const STRINGS = {
  en: { tab_chat: "Chat", tab_agents: "Agents", tab_analysis: "Analysis", input_placeholder: "Message NEXUS", mode_simple: "Simple", mode_thinking: "Thinking", new_chat: "New chat", search_chats: "Search chats", sign_in: "Sign in", try_example: "Try an example", see_how: "See how it works", language: "Language" },
